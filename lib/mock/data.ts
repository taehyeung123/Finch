...
export const linkWorkspace: LinkWorkspace = {
  ...
  blocks: [
    ...
    { id: "demo-b12", type: "events", sortOrder: 2.6, active: true, data: { label: "이번 달 일정", past: "dim", ics: true, items: [{ title: "가을 공구 오픈", startAt: "2026-08-30T20:00", place: "인스타 라이브", url: "https://example.com/order" }, { title: "팝업 스토어", startAt: "2026-09-05T11:00", endAt: "2026-09-07", place: "성수동" }] } },
  ...
  snapshot: {
    ...
    blocks: [
      ...
      { id: "demo-b12", type: "events", data: { label: "이번 달 일정", past: "dim", ics: true, items: [{ title: "가을 공구 오픈", startAt: "2026-08-30T20:00", place: "인스타 라이브", url: "https://example.com/order" }, { title: "팝업 스토어", startAt: "2026-09-05T11:00", endAt: "2026-09-07", place: "성수동" }] } },
