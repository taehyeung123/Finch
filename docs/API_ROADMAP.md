...
> **최종 대조: 2026-09-02.** 이 문서는 «앞으로 할 일» 목록이라 실제와 어긋나면 곧장 헛수고가 된다.
...
캠페인 생성·수정은 **코드가 아직 없어서** 미뤘다 — 권한 때문이 아니다.
...
4. **2단계(캠페인 생성·수정)** — 스코프는 이미 받아 둔다. 남은 건 Campaign→AdSet→Ad 3단 생성 코드다.
