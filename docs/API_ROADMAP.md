...
**⚠️ 마이그레이션은 95개다**(`0001`~`0095`, 2026-09-12 기준 — 0091·0092·0093·0094·0095 는 SQL Editor 적용 대기, 0092 는 자동 DM «지금 확인» 남용 제한, 0093 은 발행 사진·영상·처리 중 상태, 0094 는 발행 글의 대상 계정(계정을 바꾸면 옛 예약을 새 계정으로 올리지 않기), 0095 는 동의·철회 이력 + 메타 삭제 요청의 회원 연결(약관·방침 정식본, docs/LEGAL_REVIEW_2026-09.md) — 0093·0094 는 코드보다 먼저 적용, 0095 는 순서 무관). 옛 문서가 «0001~0003이면 된다»고 적어 두었는데
