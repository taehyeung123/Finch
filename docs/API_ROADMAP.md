...
**⚠️ 마이그레이션은 93개다**(`0001`~`0093`, 2026-09-11 기준 — 0091·0092·0093 은 SQL Editor 적용 대기, 0092 는 자동 DM «지금 확인» 남용 제한, 0093 은 발행 사진·영상·처리 중 상태 — 코드보다 먼저 적용). 옛 문서가 «0001~0003이면 된다»고 적어 두었는데
