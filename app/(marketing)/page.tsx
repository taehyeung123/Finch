...
import { Badge, SupportBadge } from "@/components/ui/badge";
...
export default function LandingPage() {
  return (
    <>
      ...
      {/* Hero (PART 6.1-2) */}
      <section className="mx-auto grid max-w-6xl items-center gap-10 px-4 pb-20 pt-16 md:grid-cols-2 md:px-6 md:pt-24">
        <div>
          {/* GEO: 자기완결적 정의 문장 (PART 13.3) */}
          <p className="text-[13px] font-semibold text-primary">SNS 통합 분석 & 메타광고 관리</p>
          ...
          <p className="mt-5 max-w-md text-[17px] leading-relaxed text-fg-sub">
        ...
        {/* 대시보드 목업 — 실제 컴포넌트로 구성한 미리보기 */}
        <div className="rounded-card border border-line bg-body p-5" aria-hidden>
          ...
          <div className="mt-3 rounded-card border border-line bg-surface p-4">
            ...
            <Sparkline data={[12, 28, 22, 45, 61, 58, 88]} width={380} height={56} className="mt-2 w-full" />
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-line bg-body/40">
        <div className="mx-auto max-w-6xl px-4 py-20 md:px-6">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {PAIN_POINTS.map(({ icon: Icon, persona, pain, solution }) => (
              <div key={persona} className="rounded-card border border-line bg-body p-6">
        ...
        <div className="mt-14 space-y-16">
          {FEATURES.map(({ icon: Icon, title, description, points }, i) => (
            ...
            >
              ...
              <div className="flex h-52 items-center justify-center rounded-card border border-line bg-body md:h-64" aria-hidden>
                <Icon className="size-14 text-fg-faint" />
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-20 md:px-6">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-4">
            {[
              ...
              <div
                key={p.name}
                className={`rounded-card border p-6 ${p.highlight ? "border-primary bg-primary-weak" : "border-line bg-body"}`}
              >
      ...
      {/* 연동 채널 로고 스트립 (PART 6.1-8) */}
      <section className="mx-auto max-w-6xl px-4 py-14 md:px-6">
        <p className="text-center text-[13px] font-semibold text-fg-faint">지원 채널</p>
        <div className="mt-5 flex flex-wrap items-center justify-center gap-x-10 gap-y-4 text-lg font-bold text-fg-sub">
          <span className="inline-flex items-center gap-2">
            <span className="size-2 rounded-full bg-ig" aria-hidden />
            Instagram
          </span>
          <span className="inline-flex items-center gap-2">
            <span className="size-2 rounded-full bg-tiktok-cyan" aria-hidden />
            TikTok
          </span>
          <span className="inline-flex items-center gap-2">
          ...
          <span className="inline-flex items-center gap-2">
            <span className="size-2 rounded-full bg-meta" aria-hidden />
            Meta 광고
          </span>
        </div>
      </section>
