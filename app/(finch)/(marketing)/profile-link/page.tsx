...
const HONEST_NOTES = [
  ...
  {
    title: "«최근 게시물» 블록은 채널 연동이 필요합니다",
    desc: "인스타그램·틱톡·쓰레드의 최신 글을 자동으로 띄우는 블록은 해당 채널을 연동해야 동작합니다. 채널마다 외부에 제공하는 데이터 범위가 달라 일부 항목은 비어 있을 수 있고, 핀치는 없는 값을 추정으로 채우지 않습니다.",
  },
  {
...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "네, 쓰던 페이지 주소를 붙여 넣으면 그 안의 링크를 읽어 와 블록으로 옮겨 줍니다. 옮긴 뒤에는 디자인을 다시 고르거나 AI 디자인으로 새로 만들 수 있습니다. 자동으로 옮겨지지 않는 항목은 화면에서 알려 드립니다.",
  },
  {
    q: "주소를 나중에 바꿀 수 있나요?",
  ...
  {
    q: "링크가 몇 개까지 들어가나요?",
    a: "한 페이지에 블록을 넉넉히 담을 수 있어 링크 개수로 막히는 경우는 거의 없습니다. 링크가 많아 한 화면에 담기 어렵다면, 주제별로 하위 페이지를 만들어 finch.ai.kr/내아이디/주제 형태로 나누는 방법도 있습니다.",
  },
  {
    q: "방문자 정보를 수집하나요?",
