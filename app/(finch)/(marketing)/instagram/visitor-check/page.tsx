...
export const metadata: Metadata = {
  ...
  description:
    "인스타 방문자 분석, 누가 내 인스타 봤는지 궁금하신가요? 인스타 방문자 확인·몰래보기 앱이 원리상 불가능한 이유와 인스타 언팔로우 확인·가짜 팔로워 확인의 진실을 핀치가 정직하게 설명합니다. 실제로 확인 가능한 대안도 함께 안내해드립니다.",
  keywords: [
    "인스타 방문자 분석",
    "인스타 방문자 확인",
    "인스타 방문자 보는법",
...
const FAQ_ITEMS: FaqItem[] = [
  {
    ...
    a: "네, 사실상 그렇게 봐야 합니다. 인스타그램은 프로필 방문자가 누구인지를 어떤 외부 서비스에도 알려 주지 않기 때문에, 방문자 목록을 보여준다는 앱은 무작위로 생성한 추측성 데이터를 보여주거나 실제로는 다른 목적으로 개인정보를 수집하는 경우가 대부분입니다.",
  },
  {
    q: "인스타 몰래보기 앱은 안전한가요?",
    a: "안전하지 않습니다. 인스타 몰래보기(비공개 계정 열람, 스토리 몰래보기 등)를 내세우는 앱은 인스타그램이 애초에 내주지 않는 정보를 준다고 광고하는 것이라, 로그인 정보를 요구하거나 가짜 결과를 보여주는 방식이 대부분입니다. 계정 정지와 개인정보 유출 위험이 있어 사용하지 않는 것이 좋습니다.",
  },
  {
    q: "인스타 언팔로우 확인 앱 써도 되나요?",
    a: "권장하지 않습니다. 대부분의 언팔로우 확인 앱은 인스타그램 로그인 아이디·비밀번호를 직접 입력받는 방식으로 동작하는데, 이는 인스타그램이 허용하지 않는 접근이라 계정 정지나 개인정보 유출로 이어질 수 있습니다. 정상적으로 확인할 수 있는 것은 팔로워 총량의 순증감뿐입니다.",
  },
  {
    ...
    <>
      ...
      <section className="mx-auto max-w-3xl px-4 pb-10 pt-6 md:px-6">
        ...
        <div className="mt-6 flex items-start gap-3 rounded-card border border-warning/40 bg-warning-weak p-5">
          ...
          <p className="text-[15px] leading-relaxed text-fg">
            결론부터 말씀드리면, 인스타그램은 &ldquo;누가 내 프로필을 봤는지&rdquo; 정보를 어떤
        ...
        <div className="mx-auto max-w-3xl space-y-16 px-4 py-16 md:px-6">
          <div>
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-fg-sub">
              ...
              웹사이트가 여럿 나옵니다. 하지만
              인스타그램은 프로필 조회 기록 자체를 외부에 내준 적이 없습니다. 이런 서비스가
          ...
          <div>
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-fg-sub">
              ...
              인스타그램은 &ldquo;누가 나를 언팔로우했는지&rdquo; 목록을 내주지 않습니다. 언팔로우 확인을
      ...
      <section className="mx-auto max-w-3xl px-4 py-20 md:px-6">
        ...
        <p className="mt-4 text-[15px] leading-relaxed text-fg-sub">
          ...
          정직하게 제공할 수 없습니다. 대신 핀치는 인스타그램이 계정 주인에게 보여 주는 범위 안에서 &ldquo;누가 내
