...
export const metadata: Metadata = {
  ...
  description:
    "핀치는 인스타그램 계정을 연동해 쓰는 인스타 분석 도구입니다. 팔로워 증감 추이, 참여율·도달·노출수, 인기 게시물과 릴스 성과, 해시태그, 경쟁사 계정 비교까지 인스타그램 인사이트를 무료로 확인하세요.",
...
const INSIGHT_SECTIONS: {
...
}[] = [
  {
    ...
    body: [
      "인스타그램이 계정 주인에게 보여 주는 인사이트 지표를 그대로 가져와, 앱을 직접 열지 않아도 채널 상태를 한눈에 확인할 수 있는 인스타 분석 사이트입니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "프로필 조회수와 도달·노출수까지 함께 확인할 수 있어요.",
    ],
    points: [
      "일간·주간·월간 팔로워 증감 추이",
      "프로필 조회수·도달·노출수",
  ...
  },
  {
    ...
    body: [
      ...
      "다만 타 계정 분석은 인스타그램이 밖으로 내주는 기초 지표 범위 안에서만 가능합니다. 핀치는 이 한계를 숨기지 않고 화면에 그대로 표시합니다.",
    ],
    points: ["경쟁사 계정 등록·비교", "팔로워·게시물 추이 나란히 보기", "공개된 정보로 만드는 벤치마킹 리포트"],
    badgeNote: "타 계정(경쟁사) 분석 — 공개된 기초 지표 범위",
  },
  {
...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "계정을 연동하면 일간·주간·월간 팔로워 증감 추이와 프로필 조회수·도달·노출수를 대시보드에서 바로 확인할 수 있습니다. 팔로워 연령대·성별 화면은 아직 준비 중입니다.",
  },
  {
  ...
  {
    q: "개인 계정도 분석할 수 있나요?",
    a: "인스타그램이 정한 조건 때문에 비즈니스 또는 크리에이터 계정만 연동할 수 있습니다. 개인 계정이라면 전환하는 방법을 시작 과정에서 단계별로 안내해드립니다. 전환은 무료입니다.",
  },
  {
    q: "인스타그램 경쟁사 광고도 함께 확인할 수 있나요?",
    a: "네. 게시물 성과 분석과 별도로, 메타가 공개한 광고 라이브러리를 근거로 경쟁사가 집행 중인 광고를 자동으로 감지해 알려드리는 기능도 있습니다.",
  },
];
  ...
  "@graph": [
    {
      ...
      description:
        "핀치의 인스타그램 분석은 내 계정을 연동해 팔로워 추이, 참여율, 도달·노출수, 인기 게시물과 릴스 성과, 경쟁사 계정 비교까지 하나의 대시보드에서 확인하는 인스타그램 분석 도구입니다.",
    },
    {
      "@type": "BreadcrumbList",
      itemListElement: [
    ...
    <>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-14 pt-16 text-center md:px-6 md:pt-24">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-[17px] leading-relaxed text-fg-sub">
          핀치의 인스타그램 분석은 내 계정을 연동해 팔로워 추이, 참여율, 도달·노출수, 인기 게시물과 릴스
          ...
          <Card className="flex flex-col items-start justify-between gap-4 p-6 sm:flex-row sm:items-center">
            <div>
              ...
              <p className="mt-2 max-w-xl text-[14px] leading-relaxed text-fg-sub">
                게시물에 키워드 댓글이 달리면 자동으로 DM을 보내는 방법을 정리했습니다.
              </p>
            </div>
