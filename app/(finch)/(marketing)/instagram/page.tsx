...
export const metadata: Metadata = {
  ...
  description:
    "핀치는 인스타그램 계정을 연동해 쓰는 인스타 분석 도구입니다. 팔로워 추이·연령대 통계, 참여율·도달·노출수, 인기 게시물과 릴스 성과, 해시태그, 경쟁사 계정 비교까지 인스타그램 인사이트를 무료로 확인하세요.",
...
const INSIGHT_SECTIONS: {
  ...
  },
  {
    ...
    body: [
      ...
      "인스타그램이 제공하는 범위 안에서 팔로워 연령대·성별 통계도 함께 확인할 수 있어요.",
    ],
    points: [
      "일간·주간·월간 팔로워 증감 추이",
      "연령대·성별 팔로워 통계",
...
const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "계정을 연동하면 일간·주간·월간 팔로워 증감 추이와 팔로워 연령대·성별 통계를 대시보드에서 바로 확인할 수 있습니다.",
  },
  {
